---
title: "GlycoDash v1.8.2 data processing report"
date: "`r Sys.Date()`"
output: 
  html_document:
    toc: TRUE
...
if (!is.null(params$peptide_sequences)) {
  cat("Peptide sequences in your data were abbreviated as follows:")
  params$peptide_sequences %>% 
    kableExtra::kbl() %>%
