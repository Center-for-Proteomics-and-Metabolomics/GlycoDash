...
```{r}
# TODO
# 2. Curate per biological group if user chooses to, otherwise curate everything
#    the way it is done now. (need if-else statement)
#
# 3. Per cluster and group: should get separate analyte list (per charge state).
#    Combine them (inclusively) into one analyte list.
# 
# 4. Show the results in the "Analyte curation results per cluster" box.
#    Add option to view results per biological group separately.
#    Perhaps add an option (slider) to facet by biological group?
```
