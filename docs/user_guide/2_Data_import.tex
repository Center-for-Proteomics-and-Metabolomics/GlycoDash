...
\begin{optionalbox}
	...
	\textcolor{warningorange}{
		\textbf{Experimental feature} \\
		\textsl{
			GlyCounter fragmentation matching has not yet been fully validated for all input types.
			Inspect the results carefully before using them for final analysis.
		}
	} \vspace{.5em}
	...
	\begin{itemize}[topsep=0pt, itemsep=0pt]
		...
		\item \texttt{total\_area}: Skyline MS1 total area.
		\item \texttt{isotope\_dot\_product}: Skyline isotope dot product.
		\item \texttt{mass\_accuracy\_ppm}: Skyline average mass error in ppm.
