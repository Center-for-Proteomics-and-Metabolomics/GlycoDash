...
long_data <- curate_spectra(data = long_data,
                            ...
                            min_sn = 9,
                            clusters_regex = "IgGI",
                            groups_to_filter = "Spike",
                            sample_types_to_filter = "CN")
...
analyte_list <- load_and_assign(analyte_list_file)

# analyte_list <- readxl::read_excel(analyte_list_file,
#                                    col_names = FALSE)

analyte_curated_data <- curate_analytes_with_list(data = curated_spectra,
