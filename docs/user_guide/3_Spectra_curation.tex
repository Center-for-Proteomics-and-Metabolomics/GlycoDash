...
\begin{optionalbox}
	It is possible to set manual cut-offs for a glycosylation site by toggling the \menu{\textsf{Choose cut-off values manually instead}} option in the corresponding tab.
\end{optionalbox}
