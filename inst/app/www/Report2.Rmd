---
title: "GlycoDash v1.7.0 data processing report"
output: 
  html_document:
    toc: TRUE
    toc_float: TRUE
...
## Site occupancy
```{r site_occupancy_plot, results='asis'}

if (!is.null(params$site_occupancy_plot)) {
  cat("Non-glycosylated peptides quality plot \n")
  print(htmltools::tagList(plotly::ggplotly(params$site_occupancy_plot)))
