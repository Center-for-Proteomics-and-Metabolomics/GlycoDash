...
*Analyte curation per biological group.*

```{r}
# TODO
#
# - Bug: table with bio classes shows too many entries (NA is probably empty line)
#
# - Show shinybusy modal spinner while analyte curation is being performed.
#
# - Make sure message is shown at the right time.
#
# - Try to fix the bug that each tab has to be clicked.
#
# - Samples with biological group NA (pools, blanks) should be dropped      
#   automatically.
#
# - There should be an option to exclude certain biological groups.
#
# - Per cluster and group: should get separate analyte list (per charge state).
#   Combine them (inclusively) into one analyte list.
#
# - Make sure "Export results" works, and that the data is correctly passed on
#   to the next tabs.
#
# - Show table on the right with clusters that can be chosen? [not urgent]
```
