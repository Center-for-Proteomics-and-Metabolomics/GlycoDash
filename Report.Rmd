...
```{r analyte-curation-plot-table, results='markup'}

# if (params$analyte_curation_method == "Curate analytes based on data") {
#   if (length(params$analyte_curation_plot) > 1) {
#     unlist(params$analyte_curation_plot,
#            recursive = FALSE)
#   } else {
#     params$analyte_curation_plot
#   }
# }
# 
# if (length(params$analyte_curation_table) > 1) {
#   unlist(params$analyte_curation_table,
#          recursive = FALSE)
# } else {
#   params$analyte_curation_table
# }
...
```{r repeatability-plots, results='markup'}

# unlist(params$repeatability_1, 
#        recursive = FALSE)
# 
# if (!is.null(params$repeatability_2)) {
#   unlist(params$repeatability_2, 
#        recursive = FALSE)
# }
