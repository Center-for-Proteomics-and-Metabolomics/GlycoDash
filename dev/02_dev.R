...
usethis::use_package("shinycssloaders")  # Remove if not used
usethis::use_package("shinybusy")        # Remove if not used
...
golem::add_module( name = "curate_based_on_controls" )
golem::add_module( name = "curate_based_on_percentiles" )
...
golem::add_module( name = "tab_curated_analytes" )
...
golem::add_module( name = "tab_repeatability_plot" )
