...
if (!is.null(params$quantitation_protein_tab_contents)) {
  ...
  cat("### Quantitation results \n")
  purrr::iwalk(params$quantitation_protein_tab_contents, function(results, name) {
    cat("####", name, "\n")
    contents <- params$quantitation_protein_tab_contents[[name]]
    # Quantities boxplot
...
# if (!is.null(params$quantitation_peptide_tab_contents)) {
#   cat("### Quantitation quality check \n")
#   purrr::iwalk(params$quantitation_peptide_tab_contents, function(results, name) {
#     cat("####", name, "\n")
#     contents <- params$quantitation_peptide_tab_contents[[name]]
#     quality_plot <- plotly::ggplotly(contents$quality_plot, tooltip = "text")
#     print(htmltools::tagList(quality_plot))
#     cat("Sample types excluded from quality plot:")
#   })
# }
```
