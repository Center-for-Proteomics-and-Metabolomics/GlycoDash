...
if (params$analyte_curation_method == "Curate analytes based on data") {
  ...
  tables <- params$analyte_curation_plot[names(params$analyte_curation_plot) == "table"]
  plots <- params$analyte_curation_plot[names(params$analyte_curation_plot) == "plot"]
