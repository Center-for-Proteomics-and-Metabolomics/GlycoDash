...
RUN Rscript -e 'remotes::install_version("rlang",upgrade="never", version = "1.1.6")'
RUN Rscript -e 'remotes::install_version("glue",upgrade="never", version = "1.8.0")'
RUN Rscript -e 'remotes::install_version("processx",upgrade="never", version = "3.8.6")'
...
RUN Rscript -e 'remotes::install_version("purrr",upgrade="never", version = "1.0.4")'
...
RUN Rscript -e 'remotes::install_version("writexl",upgrade="never", version = "1.5.4")'
