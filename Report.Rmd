...
if (params$analyte_curation_method == "Curate analytes based on data") {
  ...
  tables <- params$analyte_curation_objects[stringr::str_subset(
    string = names(params$analyte_curation_objects),
    pattern = "table")]
  plots <- params$analyte_curation_objects[stringr::str_subset(
    string = names(params$analyte_curation_objects),
    pattern = "plot")]
