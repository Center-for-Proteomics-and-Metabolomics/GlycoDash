...
analyte_curated_data <- dplyr::left_join(curated_analytes, curated_spectra)
...
analyte_list <- readxl::read_excel(analyte_list_file,
                                   col_names = FALSE)
analyte_list <- as.data.frame(analyte_list)
blob <- tibble::as_tibble(analyte_list)
save(analyte_list, file = "analyte_list.rds")
